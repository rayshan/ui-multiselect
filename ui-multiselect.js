angular.module('underline', []).filter('underline', [() => (text, query) => {
...
angular.module('ui.multiselect', []).directive('uiMultiselect', [() => ({
    ...
    link(scope, element, attrs) {
        ...
        scope.$watch('[focusInput, hoverSelector]', newValue => {
            scope.showSelector = newValue.some(element => element);
